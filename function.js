...
// const mowva={
//   name:'arrowfunction',
//   definition:'current context',
//   currentContext:function(){
// console.log(`to access key inside an object we use ${this.name} in current context object is block scope`);
// console.log(this);
