...
console.log(typeof Number("vv"));
console.log(parseInt("9fvdfvefefvdfvdef"));
console.log(parseFloat("2.94rfefrrdfvvffvrffvdfvdfv"));

console.log(isNaN('4rgerr55555'));
...
console.log(Math.floor(Math.random() * 10 + 1));
console.log(Math.min(0,4,55,66));
console.log(Math.max(0,4,55,66));
